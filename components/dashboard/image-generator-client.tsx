...
const ASPECT_RATIOS: Array<{ value: ImageAspectRatio; label: string; detail: string }> = [
  { value: "1:1", label: "1:1", detail: "Feed, бүтээгдэхүүн" },
  { value: "4:5", label: "4:5", detail: "Instagram пост" },
  { value: "16:9", label: "16:9", detail: "Cover, website" },
];

const PROMPT_HINTS = [
  "өнгө, гэрэлтүүлэг, камерын өнцгийг тодорхой бичих",
  "брэндийн мэдрэмж, орчны уур амьсгалыг оруулах",
          ...
          <div className="space-y-5 p-4 sm:p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <p className="mt-1 max-w-sm text-sm leading-6 text-slate-600">
                      Мобайл дээр хурдан ашиглахад зориулагдсан энгийн урсгал. Промпт, харьцаа,
            ...
            <section className="rounded-[1.5rem] border border-slate-200/70 bg-white/80 p-4 shadow-sm sm:p-5">
              ...
              <textarea
                ...
                placeholder="Жишээ: Минимал студид байрласан бүтээгдэхүүн, зөөлөн cyan гэрэлтэй, cinematic product shot, clean background..."
                rows={6}
            ...
            <section className={`${settingsOpen ? "block" : "hidden lg:block"} rounded-[1.5rem] border border-slate-200/70 bg-white/80 p-4 shadow-sm sm:p-5`}>
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">Хэрэглэх сувгаасаа хамаарч харьцаагаа сонгоно уу.</p>
              </div>
          ...
          <section className="brand-shell brand-grid overflow-hidden rounded-[2rem] p-6 text-white sm:p-7">
            <div className="relative z-10 flex h-full flex-col justify-between gap-6">
              <div>
                ...
                <h2 className="mt-4 text-2xl font-semibold sm:text-3xl">Постли өнгө аястай, цэвэр preview</h2>
                <p className="mt-3 max-w-xl text-sm leading-6 text-slate-200">
                  Гарсан зураг эхлээд энд харагдана. Мобайл дээр download товч үргэлж ил гарч, нэг гараар ашиглахад хялбар байна.
                </p>
              </div>
          ...
          <aside className="grid gap-4">
            <div className="rounded-[1.75rem] border border-cyan-100 bg-white/80 p-5 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
                <li>1. Гол обьектоо эхэнд нь бич</li>
                <li>2. Орчин, өнгө, гэрлээ дараа нь нэм</li>
        ...
        <section className="mt-5 rounded-[2rem] border border-white/70 bg-white/85 p-4 shadow-[0_22px_50px_rgba(9,38,66,0.08)] sm:p-6">
          {isPending ? (
            ...
            <div className="flex min-h-[24rem] flex-col items-center justify-center rounded-[1.75rem] border border-dashed border-slate-200 bg-slate-50/70 px-6 text-center">
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-slate-600">
                Промптоо сайн тодорхой бичээд үүсгэхэд хангалттай. Мобайл дээр preview томоор харагдах байдлаар тохируулсан.
              </p>
            </div>
          )}
        </section>
