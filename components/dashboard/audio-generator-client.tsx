                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="mt-1 max-w-sm text-sm leading-6 text-slate-600">
                      Ð¥Ð°Ñ€Ð¸Ð»Ñ†Ð°Ð½ ÑÑ€Ð¸Ð°Ð½Ñ‹ Ð¼Ó©Ñ€Ò¯Ò¯Ð´ÑÑ Ð¾Ñ€ÑƒÑƒÐ»Ð°Ð°Ð´, Ð´ÑƒÑƒ Ñ…Ð¾Ð¾Ð»Ð¾Ð¹Ð³Ð¾Ð¾ ÑÐ¾Ð½Ð³Ð¾Ð½ Ð½ÑÐ³ Ð´Ð¾Ñ€ MP3 Ð±Ð¾Ð»Ð³Ð¾Ð½ Ð³Ð°Ñ€Ð³Ð°Ð½Ð°.
                    </p>
                  </div>
                </div>
                ...
                {lines.map((line, index) => (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      placeholder={`${index + 1}-Ñ€ Ð¼Ó©Ñ€Ð¸Ð¹Ð½ Ñ‚ÐµÐºÑÑ‚`}
                      rows={3}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              >
                {isPending ? (
                  ...
                  `ÐÑƒÐ´Ð¸Ð¾ Ò¯Ò¯ÑÐ³ÑÑ… Â· ${pricing.current_cost} ÐºÑ€`
                )}
              </button>
          ...
          <section className="brand-shell brand-grid overflow-hidden rounded-[2rem] p-6 text-white sm:p-7">
            <div className="relative z-10 flex h-full flex-col justify-between gap-6">
              <div>
                ...
                <h2 className="mt-4 text-2xl font-semibold sm:text-3xl">ÐÑÐ³ Ð´ÑÐ»Ð³ÑÑ† Ð´ÑÑÑ€ Ð±Ð¸Ñ‡Ð¸Ñ…, Ò¯Ò¯ÑÐ³ÑÑ…, ÑÐ¾Ð½ÑÐ¾Ñ…</h2>
                <p className="mt-3 max-w-xl text-sm leading-6 text-slate-200">
                  Mobile Ñ…ÑÑ€ÑÐ³Ð»ÑÐ³Ñ‡Ð¸Ð´ Ñ‚ÐµÐºÑÑ‚ÑÑ Ð·Ò¯Ò¯Ð½ Ñ‚Ð°Ð»Ð´ Ð±ÑÐ»Ð´ÑÑÐ´, Ð³Ð°Ñ€ÑÐ°Ð½ MP3-Ð°Ð° Ð±Ð°Ñ€ÑƒÑƒÐ½ Ñ‚Ð°Ð»Ð´ ÑˆÑƒÑƒÐ´ ÑÐ¾Ð½ÑÐ¾Ð½Ð¾.
                </p>
              </div>
          ...
          <aside className="grid gap-4">
            <div className="rounded-[1.75rem] border border-cyan-100 bg-white/80 p-5 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
                ...
                <li>3. Ð”ÑƒÑƒ Ñ…Ð¾Ð¾Ð»Ð¾Ð¹Ð½ ÑƒÑƒÑ€ Ð°Ð¼ÑŒÑÐ³Ð°Ð»Ñ‹Ð³ Ñ‚ÐµÐºÑÑ‚Ð´ÑÑ Ñ‚ÑƒÑÐ³Ð°</li>
              </ul>
            </div>
            ...
            {isPending ? (
              <div className="flex min-h-[18rem] flex-col items-center justify-center rounded-[1.5rem] border border-dashed border-cyan-200 bg-cyan-50/40 px-6 text-center">
                ...
                <p className="mt-2 max-w-md text-sm leading-6 text-slate-600">
                  Ð¥Ò¯ÑÑÐ»Ñ‚Ð¸Ð¹Ð³ Ð±Ð¾Ð»Ð¾Ð²ÑÑ€ÑƒÑƒÐ»Ð¶ Ð±Ð°Ð¹Ð½Ð°. Ð”ÑƒÑƒÑÐ¼Ð°Ð³Ñ† Ñ‚Ð¾Ð³Ð»ÑƒÑƒÐ»Ð°Ð³Ñ‡ Ð±Ð¾Ð»Ð¾Ð½ Ñ‚Ð°Ñ‚Ð°Ñ… Ñ‚Ð¾Ð²Ñ‡ Ð³Ð°Ñ€Ñ‡ Ð¸Ñ€Ð½Ñ.
                </p>
              </div>
            ) : result ? (
              ...
              <div className="flex min-h-[18rem] flex-col items-center justify-center rounded-[1.5rem] border border-dashed border-slate-200 bg-white px-6 text-center">
                ...
                <p className="mt-2 max-w-md text-sm leading-6 text-slate-600">
                  Dialogue Ð¼Ó©Ñ€Ò¯Ò¯Ð´ÑÑ Ð±Ó©Ð³Ð»Ó©Ó©Ð´ Ò¯Ò¯ÑÐ³ÑÑ…ÑÐ´ Ð±ÑÐ»ÑÐ½. Preview Ñ…ÑÑÐ³Ð¸Ð¹Ð³ mobile Ð´ÑÑÑ€ Ñ‚Ð¾Ð¼ Ñ‚Ð¾Ð²Ñ‡Ñ‚Ð¾Ð¹ Ð±Ð°Ð¹Ñ…Ð°Ð°Ñ€ ÑˆÐ¸Ð½ÑÑ‡Ð¸Ð»ÑÑÐ½.
                </p>
              </div>
            )}
          </div>
